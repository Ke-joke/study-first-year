...
public class countingSort2 {
    ...
    public static int[] countSort(int[] num, int max, int len){//Compute the count array
        ...
        return sorting(num, count, i+j);
    }

    public static int[] sorting(int[] num, int[] count, int step){//Sorting the array
        int i;
        int len2 = count.length;
        //First solution:将计数的数组从后往前排序
        for (i = len2-1; i >= 0; i--){
