...
import CS265FZ.Class_Example.AgeGroups.MyAgeGroup;
...
class MethodMappingTestAgeGroup {
    ...
    private static Stream<Arguments> parameterDataProvider( ) {
        return Stream.of(
                Arguments.of(0, "BABY"),
                Arguments.of(2, "BABY"),
                Arguments.of(3, "CHILD"),
                Arguments.of(16, "CHILD"),
                Arguments.of(17, "YOUNG_ADULT"),
                Arguments.of(30, "YOUNG_ADULT"),
                Arguments.of(31, "MIDDLE_AGED_ADULT"),
                Arguments.of(45, "MIDDLE_AGED_ADULT"),
                Arguments.of(46, "OLD_ADULT"),
                Arguments.of(150, "OLD_ADULT"),
